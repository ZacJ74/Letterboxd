...
exports.getDashboard = async (req, res) => {
    try {
        ...
        res.render('dashboard', { movies, message: null });
    } catch (err) {
        console.error(err);
...
exports.createMovie = async (req, res) => {
    try {
        const newMovie = new Movie({
            ...
            user: req.session.user._id // attach current user
        });
        await newMovie.save();
        res.redirect('/');
    } catch (err) {
...
// --- Edit Movie Form (requires requireOwner) ---
exports.getEditMovieForm = (req, res) => {
    res.render('movies/edit', { movie: req.movie });
};

// --- Update Movie (requires requireOwner) ---
...
// --- Delete Movie (requires requireOwner) ---
